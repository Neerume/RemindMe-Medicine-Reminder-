...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  // If you are not using this yet, you can comment it out to avoid unused variable warnings
  // final MedicineController _medicineControllerApi = MedicineController();
  ...
  // --- CHANGE 2: NEW SAVE LOGIC USING GAL ---
  Future<void> _saveReportToGallery(BuildContext dialogContext) async {
    try {
      ...
      // Handles permission denied or specific errors
      ScaffoldMessenger.of(context).showSnackBar(
                      ...
                      children: [
                        CircleAvatar(
                          ...
                          backgroundImage: _profileImage != null
                              ...
                              : (backendPhotoBase64 != null
                                  ? MemoryImage(
                                      base64Decode(backendPhotoBase64!))
